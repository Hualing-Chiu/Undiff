...
logging.basicConfig(filename='/home/hualing/Undiff/results_three_spk/source_separation_inference/each_sisnr.txt', level=logging.INFO, format='%(message)s')
...
if __name__=="__main__":
    original_path = "/home/hualing/Undiff/results_three_spk/source_separation_inference/original"
    degraded_path = "/media/md01/home/hualing/Undiff/results/source_separation_inference/degraded"
    generated_path = "/home/hualing/Undiff/results_three_spk/source_separation_inference/generated"
    ...
    for i in tqdm(range(N)):
        ...
        generated_ws = [torch.cat([generated_w1, generated_w2, generated_w3], -1).view(1, 1, -1),
                        torch.cat([generated_w2, generated_w1, generated_w3], -1).view(1, 1, -1),
                        torch.cat([generated_w3, generated_w1, generated_w2], -1).view(1, 1, -1),
                        torch.cat([generated_w2, generated_w3, generated_w1], -1).view(1, 1, -1),
                        torch.cat([generated_w1, generated_w3, generated_w2], -1).view(1, 1, -1),
                        torch.cat([generated_w3, generated_w2, generated_w1], -1).view(1, 1, -1)]
